...
export default function Core() {
  ...
  return (
    <>
      {STORE.form.SendMail.status === 400 && < ModalError />}
            ...
            <div className={`${STORE.form.darkModeForm.bodyRight} loo col-md-8 col-lg-9 col-11 col-sm-11`}>
              <form onSubmit={formik.handleSubmit}>
                ...
                <div className='submit-btn'>
                  ...
                  {!Object.values(formik.errors)[0] &&  <div id='test-server'><label id='errorValidate'><div id='test-server'><label>Test your mail server</label></div></label></div> }
