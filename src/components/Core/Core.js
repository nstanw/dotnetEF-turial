        ...
        <div id="wCore">
            ...
            <div className="aWindow row">
                ...
                <div className="aWindow-header col-lg-12 col-sm-12 row">
                    <div className="col-lg-11 col-sm-11  SMTPer-aligt">
                        <span className="aWindow-header-title ">
                            <iconify-icon className="icon-navb" icon="akar-icons:grid"></iconify-icon>   SMTPer
                        </span>
                    </div>
                ...
                <div className="aWindow-flex col-lg-12 col-sm-12 container row">
                    {/* <!-- Left Menu --> */}
                    <div id="test-check" className="aWindow-menu col-lg-4 col-sm-2">
                        <div className="aWindow-menu-item on d-none d-sm-block">
                            Test &amp; Check
                        </div>
                        <div className="">
                            <iconify-icon className="floatRight" icon="bi:send"></iconify-icon>
                        </div>
                    </div>
                        ...
                        <form onSubmit={hanldSubmit}>
                            <div className="row">
                                <div className="col-lg-6">
                                    ...
                                    <input name="SMTPhost" type="text" placeholder="required"></input>
                                </div>
                                <div className="col-lg-6 d-none d-sm-block ">
                                    <p>host or ip address of your smtp server (example: smtp.company.com)</p>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <label>Port</label> <br />
                                    <input name="Port" type="number" placeholder="required"></input>
                                </div>
                                <div className="col-lg-6 d-none d-sm-block">
                                    <p>the default port is 25, but some smtp servers use a custom port (example: 587)</p>
                                </div>
                            </div>

                            <div className="row">
                                <div className="col-lg-6">
                                    <input value={true} id="UseSsl" name="UseSsl" type="checkbox"></input>
                                    <label
                                        htmlFor="UseSsl"
                                    >Use Secured Connection</label>
                                </div>
                                <div className="col-lg-6 d-none d-sm-block">
                                    <p>checked it only if the smtp server needs a secured connection (ssl, tsl)</p>
                                </div>
                            </div>

                            <div className="row">
                                <div className="col-lg-6">
                                    <input value={true} id="UseDefaultCredentials" name="UseDefaultCredentials" type="checkbox"></input>
                                    <label
                                        htmlFor="UseDefaultCredentials"
                                    >Use authentication</label>
                                </div>
                                <div className="col-lg-6 d-none d-sm-block">
                                    <p>most of smtp servers need an authentication (login/password). Check it if required</p>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-lg-6 ">
                                    ...
                                    <input name="Email" type="text" placeholder="not required"></input>
                                </div>
                                <div className="col-lg-6 d-none d-sm-block">
                                    <p>required if 'Use authentication' is checked (ex: account or account@foo.com)</p>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    ...
                                    <input name="Password" type="text" placeholder="not required"></input>
                                </div>
                                <div className="col-lg-6 d-none d-sm-block">
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    ...
                                    <input name="From" type="text" placeholder="required"></input>
                                </div>
                                <div className="col-lg-6 d-none d-sm-block">
                                    <p>
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    ...
                                    <input name="To" type="text" placeholder="required"></input>
                                </div>
                                <div className="col-lg-6 d-none d-sm-block">
                            ...
                            <button type="submit" className="floatRight aWindow-button ">
                                <iconify-icon className="floatRight" icon="bi:send"></iconify-icon>
                                Send
                            </button>
                        </form>
